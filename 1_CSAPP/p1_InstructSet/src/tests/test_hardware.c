...
static void TestAddFunctionCallAndComputation()
{
    ...
    write64bits_dram(virAddr2phyAddr(0x7ffffffee110, cr), 0x0000000000000000, cr);    // rbp
    write64bits_dram(virAddr2phyAddr(0x7ffffffee108, cr), 0x0000000000000000, cr);
    write64bits_dram(virAddr2phyAddr(0x7ffffffee100, cr), 0x0000000012340000, cr);
    write64bits_dram(virAddr2phyAddr(0x7ffffffee0f8, cr), 0x000000000000abcd, cr);
    write64bits_dram(virAddr2phyAddr(0x7ffffffee0f0, cr), 0x0000000000000000, cr);    // rsp
    ...
    for (int i = 0; i < 15; ++ i)
    {
        writeinst_dram(virAddr2phyAddr(i * 0x40 + 0x00400000, cr), assembly[i], cr);
    }
    ...
    match = match && (read64bits_dram(virAddr2phyAddr(0x7ffffffee110, cr), cr) == 0x0000000000000000); // rbp
    match = match && (read64bits_dram(virAddr2phyAddr(0x7ffffffee108, cr), cr) == 0x000000001234abcd);
    match = match && (read64bits_dram(virAddr2phyAddr(0x7ffffffee100, cr), cr) == 0x0000000012340000);
    match = match && (read64bits_dram(virAddr2phyAddr(0x7ffffffee0f8, cr), cr) == 0x000000000000abcd);
    match = match && (read64bits_dram(virAddr2phyAddr(0x7ffffffee0f0, cr), cr) == 0x0000000000000000); // rsp
...
static void TestSumRecursiveCondition()
{
    ...
    write64bits_dram(virAddr2phyAddr(0x7ffffffee230, cr), 0x0000000008000650, cr);    // rbp
    write64bits_dram(virAddr2phyAddr(0x7ffffffee228, cr), 0x0000000000000000, cr);
    write64bits_dram(virAddr2phyAddr(0x7ffffffee220, cr), 0x00007ffffffee310, cr);    // rsp
    ...
    match = match && (read64bits_dram(virAddr2phyAddr(0x7ffffffee230, cr), cr) == 0x0000000008000650); // rbp
    match = match && (read64bits_dram(virAddr2phyAddr(0x7ffffffee228, cr), cr) == 0x0000000000000006);
    match = match && (read64bits_dram(virAddr2phyAddr(0x7ffffffee220, cr), cr) == 0x00007ffffffee310); // rsp
